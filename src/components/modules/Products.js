   ...
   <div className="grid md:grid-cols-2 items-center gap-8 max-w-7xl mx-auto mb-20">
        ...
        <div>
          ...
          <p className="text-[24px] font-medium text-gray-300 leading-relaxed mb-6">
            این محصول اولین نسل پهپادهای هوشمند عمودپرواز تولید شده در ایران است.
            دارای بخش کنترل پرواز پیشرفته‌ای است که آن را برای کاربردهای بسیاری
      ...
      <div className="grid md:grid-cols-2 items-center gap-8 max-w-7xl mx-auto mb-20">
        <div>
          <h2 className="text-[32px] font-semibold mb-2">
            پهپاد عمود پرواز هوشمند{" "}
            <span className="text-[32px] font-semibold text-gray-400">ورژن ۱.۲</span>
          </h2>
          <p className="text-[24px] font-medium text-gray-300 leading-relaxed mb-6">
            این محصول اولین نسل پهپادهای هوشمند عمودپرواز تولید شده در ایران است.
            دارای بخش کنترل پرواز پیشرفته‌ای است که آن را برای کاربردهای بسیاری
          ...
          <button className="text-[18px] font-medium border border-yellow-400
           text-yellow-400 px-6 py-2 rounded-full hover:text-white transition">
            اطلاعات بیشتر
          </button>
        </div>
